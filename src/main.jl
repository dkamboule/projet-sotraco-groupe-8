...
Description
main.jl est le point d'entrée principal du projet SOTRACO (Simulateur de Transport). Ce fichier orchestre l'exécution complète du système d'analyse et d'optimisation des transports en commun.
